...
plots.plot_potentials_from_km_results(results_by_interval, output_dir=output_dir, range_label=range_label, detrend=bool(detrend))
...
plots.plot_price_series(finest_df, output_dir=output_dir, range_label=range_label, smooth_window=20, detrend=bool(detrend))
